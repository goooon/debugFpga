...
vlog -work work ddr_clk_tb.v

REM run the simulation
vsim -c -t ps +transport_int_delays -voptargs="+acc" -L secureip -L simprims_ver -sdfmax ddr_clk_tb\dut=..\..\implement\results\routed.sdf +no_notifier work.ddr_clk_tb work.glbl
