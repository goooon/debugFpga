...
xst -ifn xst.scr
move systemclk_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\systemclk_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc systemclk_exdes.ucf systemclk_exdes

echo 'Running map'
map -timing -pr b systemclk_exdes -o mapped.ncd
...
netgen -ofmt verilog -sim -sdf_anno false -tm systemclk_exdes -w routed.ncd routed.v
cd ..
